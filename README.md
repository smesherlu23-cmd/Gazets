...
| | |
|---|---|
| ![Вёрстка](docs/screenshots/layout.png) | ![Редактор издания](docs/screenshots/publication.png) |
| ![Новый выпуск](docs/screenshots/wizard.png) | ![Редактор статьи](docs/screenshots/article.png) |
